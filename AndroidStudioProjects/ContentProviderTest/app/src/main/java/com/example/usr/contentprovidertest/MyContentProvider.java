...
public class MyContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri
            .parse("content://com.example.usr.contentprovidertest.myProvider/email");

    //UriMatcher에서 URI의 형태를 구분할 때 사용할 상수 정의
    private static final int DATAS = 1; //집합 데이터
    private static final int DATA_ID = 2; //단일 데이터
    ...
    static {
        ...
        myURIMatcher.addURI("com.example.usr.contentprovidertest.myProvider", "email", DATAS);
        myURIMatcher.addURI("com.example.usr.contentprovidertest.myProvider", "email/#", DATA_ID);
    }
    ...
    public String getType(Uri uri) {
        switch (myURIMatcher.match(uri)) {
            case DATAS:
                return "com.example.usr.contentprovidertest.myProvider.dir";
            case DATA_ID:
                return "com.example.usr.contentprovidertest.myProvider.item";
            default:
                return null;
        }
    }
